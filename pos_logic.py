...
# ========================================================================= #
# ฟังก์ชันเกี่ยวกับการชำระเงิน (Checkout)
# ========================================================================= #

def process_checkout():
    """
    ดำเนินการชำระเงิน: ตัดสต็อก, บันทึกการขาย, และสร้างใบเสร็จ
    คืนค่า: (success: bool, message: str, pdf_file: str หรือ None)
        - success=True: ชำระเงินสำเร็จ
        - success=False: สต็อกไม่พอ หรือตะกร้าว่าง
    """
    bill_path = get_bill_path()
